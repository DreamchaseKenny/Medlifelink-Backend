...
class HospitalController extends Controller
{
    //
     ...
     /**
     * Display a listing of the Doctors by hospital.
     */
    public function getDoctors(Request $request)
    {
        ...
        if($validator->fails()){
            ...
            $users = User::where("created_by",$request->hospital_id)->where("role","doctor")->orderBy("id","desc")->get();
    ...
    public function getPatients(Request $request)
    {
        ...
        if($validator->fails()){
            ...
            $users = User::where("created_by",$request->hospital_id)->where("role","patient")->orderBy("id","desc")->get();
            return response()->json([
    ...
    public function createUser(Request $request)
    {
        ...
        if($validator->fails()){
            ...
            $request['created_by'] =   $request['hospital_id'];

            $user = User::create($request->all());
             $user->created_by = $request['hospital_id'];
